...
var _gsapAnimateJs = require("./gsapAnimate.js");
(0, _gsapAnimateJs.greensock)();
// ===============================
// === ICONIC PLAYERS  =======
// ===============================
// Zinedine Zidane
const zizou = new (0, _playerJs.TitleHolder)("Zinedine Zidane", "Nickname: Zizou", "images/iconic-Zidane.jpg", 126, 14, 5);
// Roberto Carlos
const carlos = new (0, _playerJs.Participant)("Roberto Carlos", "Nickname: El Hombre ", "images/iconic-roberto-carlos.webp", 131, 22, 11);
// ===============================
// ======== LEGENDS ==============
// ===============================
// Cristiano Ronaldo AKA CR7
const cr7 = new (0, _playerJs.TitleHolder)("CR7", "Nickname: EL BICHO", "images/legends-Ronaldo.webp", 923, 39, 9);
// Gareth Bale
const bale = new (0, _playerJs.Participant)("BALE", "Nickname: El Golfer", "images/legends-BALE.webp", 181, 16, 9);
// ===============================
// ======== GREAT PLAYERS ========
// ===============================
// Vini Jr
const vini = new (0, _playerJs.TitleHolder)("VINI-JR", "Nickname: Pajaro Loco", "images/great-VINI-JR-v2.png", 62, 7, 5);
// Rodrygo
const rodyrgo = new (0, _playerJs.Participant)("RODYRGO", "Nickname: El Rayo", "images/great-rodyrgo.png", 45, 6, 4);
// ===============================
// === MATCHING PLAYERS TO RANKS ==
// ===============================
// Iconic Players Rank
const IconicPlayers = new (0, _rankJs.Rank)("Iconic Players");
IconicPlayers.addPlayer(zizou);
IconicPlayers.addPlayer(carlos);
// Legends Rank
const Legends = new (0, _rankJs.Rank)("LEGENDS");
Legends.addPlayer(cr7);
Legends.addPlayer(bale);
// Great Rank
const Great = new (0, _rankJs.Rank)("Great");
...
function changeGame() {
    ...
    let selectedGame;
    if (selectedGameName === "IconicPlayers") selectedGame = IconicPlayers;
    else if (selectedGameName === "Great") selectedGame = Great;
    else if (selectedGameName === "LEGENDS") selectedGame = Legends;
    if (selectedGame) selectedGame.renderGamePlayers(listPlayersContainer);
}
// ===============================
// === EVENT LISTENER ============
// ===============================
...
},{"./Rank.js":"lKAcw","./Player.js":"8MdHU","./gsapAnimate.js":"1A8Bn"}],"lKAcw":[function(require,module,exports,__globalThis) {
...
},{}],"8MdHU":[function(require,module,exports,__globalThis) {
// ===============================
// ======== PLAYER BASE CLASS =====
// ===============================
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "TitleHolder", ()=>TitleHolder);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1A8Bn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9ObT8","bqx5n"], "bqx5n", "parcelRequiref3f9")

//# sourceMappingURL=Anna_Nguyen_Ali_El-Maniary_HW2_OOP.4083621f.js.map
